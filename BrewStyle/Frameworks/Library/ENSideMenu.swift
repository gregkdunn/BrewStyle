...
public class ENSideMenu : NSObject, UIGestureRecognizerDelegate {
    ...
    public var menuWidth : CGFloat = 360.0 {
        didSet {
    ...
    private var blurStyle: UIBlurEffectStyle = .ExtraLight
...
*/
    ...
    */
    ...
    private func toggleMenu (shouldOpen: Bool) {
        ...
        if (bouncingEnabled) {
            ...
            if (menuPosition == .Left) {
                ...
                pushMagnitude = (shouldOpen) ? 95 : -95
	...
	public func gestureRecognizer(gestureRecognizer: UIGestureRecognizer, shouldReceiveTouch touch: UITouch) -> Bool {
		...
		//print("gestureshouldreceive")
		
		if touch.view is GKDRangeSliderView {
			//print("-canceled because its a GKDRangeSliderView")
			return false
		}
		//print("-accepted")
		return true
