...
class FilterView: GradientView {
	...
	func commonInit () {
		...
		self.backgroundColor = AppStyle.FilterMenu[.BackgroundColor]
		self.gradientWithColors((position: 0.0, color: AppColor.White.alpha(0.5)), bottomStop: (position: 1.0, color: AppColor.White.alpha(0.0)))
		...
		sortButton.topAnchor.constraintEqualToAnchor(sortView.topAnchor, constant: AppMargins.large.margin - 1).active = true
		...
		filterTypeView.bottomAnchor.constraintEqualToAnchor(sortView.topAnchor, constant: AppMargins.xl.negative + 4).active = true
		...
		filterButton.topAnchor.constraintEqualToAnchor(self.topAnchor, constant: AppMargins.xl.margin - 1).active = true
